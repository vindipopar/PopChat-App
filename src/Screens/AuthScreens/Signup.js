...
import logo from '../../Assets/poplogo.png'
  ...
  constructor(props) {
    ...
    this.state = {
      formData: {
        ...
        full_name: '',
        email: '',
        image: 'https://img.pngio.com/profilepng-512512-profile-png-512_512.png',
        password: ''
      },
      showToast: false,
      isLoading: false,
          ...
          <Form style={styles.form}>
            ...
            </Item>
            {
              this.state.isLoading == false ?
                <Button full success style={styles.btnSignup} onPress={this.handleSubmit}>
                  <Text style={styles.textSignup}>SIGN UP</Text>
                </Button>
                :
                <Button full success style={styles.btnSignup} onPress={this.handleSubmit} disabled>
