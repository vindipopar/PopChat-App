            ...
            <Container>
                ...
                <Content style={styles.content} >
                    ...
                    <View style={styles.buttonWrap}>
                        {
                            isLoading ?
                                <Button success style={styles.btnSave} onPress={this.handleSave} disabled>
                                    <Spinner color='white' style={styles.loading} /><Text style={styles.textBtnLoading}> SAVE </Text>
                                </Button>
                                :
                                <Button success style={styles.btnSave} onPress={this.handleSave}>
